...
@AllArgsConstructor
@NoArgsConstructor
public enum ResultCodes implements IResultCode, Serializable {

    SUCCESS("00000", "Everything is fine"),
    ...
    public static ResultCodes getValue(String code){
        for (ResultCodes value : values()) {
